    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 col-md-6 mb-4">
        <div class="position-relative text-center p-4" style="background-color: #fdf8ef; border: 1px #c4965c">
          <% if $hasDiscount %>
          <div class="position-absolute top-0 start-0 m-3 px-2 py-1 rounded text-white small fw-bold" style="background-color:#c4965c;">
      ...
      <div class="col-lg-6 col-md-6">
        ...
        <div class="mb-4">
          <% if $hasDiscount %>
            <span class="text-muted text-decoration-line-through me-2">Rp $FormattedPrice</span>
            <span class="fw-bold" style="color:#c4965c;">Rp $FormattedDiscountPrice</span>
          <% else %>
            <span class="fw-bold" style="color:#c4965c;">Rp $FormattedPrice</span>
          <% end_if %>
        </div>
        ...
        <div class="d-flex align-items-center">
          <strong class="me-3">Jumlah :</strong>
          
          <div class="input-group me-3" style="width:130px;">
            <button class="btn btn-outline-secondary" type="button" onclick="changeQuantity(-1)">-</button>
            <input type="number" id="quantity" class="form-control text-center" value="1" min="1" max="$Stock" readonly>
            <button class="btn btn-outline-secondary" type="button" onclick="changeQuantity(1)">+</button>
          </div>

          <button class="btn text-white fw-bold px-4 me-2" style="background-color:#c4965c;" onclick="addToCart()">keranjang</button>
          <button class="btn btn-outline-secondary" title="Add to Wishlist"><i class="far fa-heart"></i></button>
        </div>
        <% else %>
